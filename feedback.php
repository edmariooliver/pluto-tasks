...
<?php 
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        Feedback::enviar_feedback($_POST['titulo'], $_POST['texto'], $_SESSION['user']->getEmail());
    }
...
<div class="row">
    ...
    <h4>Feedback</h4>
        <form action="" class='' method='post'>
            <input name ='titulo' require placeholder='Título'class='form-control'type="text">
            <textarea name="texto" id="" cols="40" class='form-control' rows="10">Em que poderíamos melhorar?</textarea>
